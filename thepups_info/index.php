	      ...
	      <div class="row">
			<div class="col-md-4">
				<h2>DBS Dog Counts</h2>
		         <?php include("https://prod-the-pups-snippets-2020.s3.amazonaws.com/dbs_dog_counts.html") ?>
				 <br>
				
				<h2>Staff/BPA Dog Counts</h2>
				  <?php include("https://prod-the-pups-snippets-2020.s3.amazonaws.com/staff_dog_counts.html") ?>
				<br>
				
				<p><a class="btn btn-default" href="./dog_info.php" role="button">View details &raquo;</a></p>
				
				<br>
				<em>Dog counts current as of <?php include("https://prod-the-pups-snippets-2020.s3.amazonaws.com/dog_count_timestamp.html") ?> </em>
			</div>
			
			<div class="col-md-4">
				<h2>Shift Counts *</h2>
				<?php include("https://prod-the-pups-snippets-2020.s3.amazonaws.com/dbs_shift_counts.html") ?>
				<br>
				<em>* No Green DBS volunteers during the shelter shutdown.</em>
				<br>
				<em>Shift counts current as of <?php include("https://prod-the-pups-snippets-2020.s3.amazonaws.com/dbs_shift_counts_timestamp.html") ?> </em>
			</div>
			
			<div class="col-md-4">
				<h2>Needs</h2>
				<?php include("https://prod-the-pups-snippets-2020.s3.amazonaws.com/dbs_shift_needs.html") ?>
				<br>
